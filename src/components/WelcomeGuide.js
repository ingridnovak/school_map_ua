...
const slides = [
    ...
    content: (
      <>
        ...
        <ul>
          ...
          <li>
            <strong>Вчитель</strong> — отримує додаткову кнопку{" "}
            <strong>«Адмін»</strong>, яка дозволяє переглядати та редагувати
            інформацію про учнів свого класу
          </li>
          <li>
    ...
    content: (
      <>
        ...
        <p className="highlight-box">
          ...
          <strong>всі 25 тестів</strong> та зробите{" "}
          <strong>благодійний внесок</strong> — ви отримаєте персональний
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          На вкладці <strong>«Ваші Пригоди»</strong> ви можете створити власну
          карту подорожей Україною!
        </p>
        <p>
          <strong>Натисніть на будь-яку область</strong>, щоб:
        </p>
