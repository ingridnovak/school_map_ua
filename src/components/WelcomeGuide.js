...
const slides = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul>
          <li>
            <strong>Учень</strong> — для школярів, які хочуть досліджувати
            Україну та пройти тестування
          </li>
          <li>
            <strong>Вчитель</strong> — для вчителів, які хочуть перевірити свої
            знання про Україну та підтримати Збройні Сили України
          </li>
          <li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          На вкладці <strong>«Досліджуємо Україну»</strong> ви побачите
        ...
        <ul>
          ...
          <li>пройти тестування на знання інформації про область</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Проходьте тести про кожну окрему область України та перевіряйте свої
          знання!
        </p>
